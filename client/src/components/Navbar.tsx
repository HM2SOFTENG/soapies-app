            ...
            {switchable && (
              <div ref={themePickerRef} className="relative">
                <motion.button
                  ...
                  className="p-2.5 rounded-xl hover:bg-pink-50 dark:hover:bg-white/10 transition-colors text-gray-600 hover:text-pink-600"
                ...
                <AnimatePresence>
                  {themePickerOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 top-full mt-2 w-52 rounded-2xl bg-[var(--popover)] border border-[var(--border)] shadow-2xl overflow-hidden z-50"
                    >
                      <div className="px-4 py-3 border-b border-[var(--border)]">
                        <p className="text-xs font-semibold text-[var(--muted-foreground)] uppercase tracking-wider">Theme</p>
                      </div>
                        ...
                        {THEMES.map(t => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <span className="text-sm font-medium block">{t.emoji} {t.label}</span>
                              <span className="text-[10px] text-[var(--muted-foreground)]">{t.description}</span>
                            </div>
                            {theme === t.id && (
                              <Check className="h-3.5 w-3.5 text-pink-500 flex-shrink-0" />
                            )}
                          </button>
                        ))}
                      </div>
              ...
              <div className="p-6">
                ...
                {switchable && (
                  <div className="mt-6 mb-2">
                    <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest px-1 mb-2">Theme</p>
                    <div className="grid grid-cols-2 gap-2">
                      {THEMES.map(t => (
                        ...
                        >
                          ...
                          <span className="text-xs font-semibold text-gray-700">{t.emoji} {t.label}</span>
                          {theme === t.id && <Check className="h-3 w-3 text-pink-500 ml-auto" />}
                        </button>
                      ))}
                    </div>
                  </div>
